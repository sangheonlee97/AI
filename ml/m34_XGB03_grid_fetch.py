...
xgb = XGBClassifier(random_state=42, device='cuda')
model = RandomizedSearchCV(xgb, param, n_jobs=-3, cv=kf, random_state=42, n_iter=10)
...
# 최상의 score :  0.963625918777981
# model.score :  0.965861466571431