...
xgb.fit(X_train, y_train, eval_set=[(X_train, y_train), (X_test, y_test)], verbose=1, 
...
print("acc : ", acc)
print("========================================================")
# print("hist : ", xgb.evals_result())

import matplotlib.pyplot as plt
hist = xgb.evals_result()
# hist = hist.values()
print(hist['validation_0']['logloss'])
plt.scatter(x=range(len(hist['validation_0']['logloss'])), y=hist['validation_0']['logloss'], label='logloss_train', marker='.')
plt.scatter(x=range(len(hist['validation_1']['logloss'])), y=hist['validation_1']['logloss'], label='logloss_test', marker='.')
plt.legend()
