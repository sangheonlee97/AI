...
model = RandomizedSearchCV(xgb, param, n_jobs=-3, cv=kf, random_state=42, n_iter=30)
...
# 최상의 매개변수 :  {'subsample': 0.7, 'n_estimators': 300, 'min_child_weight': 0, 'max_depth': 5, 'learning_rate': 0.2, 'gamma': 0}
# 최상의 score :  0.8361637972609698
# model.score :  0.8351827640111974