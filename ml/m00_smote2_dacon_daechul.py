...
# train_csv = train_csv[train_csv['대출등급'] != 'G'] # 대출등급 G 삭제
# train_csv = train_csv[train_csv['대출등급'] != 'F'] # 대출등급 F 삭제
print(train_csv.shape)
...
print("jst",X_train.shape)

smote = SMOTE(random_state=42)
X_train, y_train = smote.fit_resample(X_train, y_train)

print("sm",X_train.shape)
