...
# 최상의 매개변수 :  {'n_estimators': 1000, 'max_depth': 3, 'learning_rate': 0.01}
# 최상의 score :  0.40852927506045
# model.score :  0.44672912536580245


xgb.set_params(learning_rate=0.01, n_estimators=1000, max_depth = 3)
xgb.fit(X_train, y_train)

result = xgb.score(X_test, y_test)
print(result)
print("par : ", xgb.get_params())