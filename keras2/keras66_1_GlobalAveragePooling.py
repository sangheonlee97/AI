...
print(X_test.shape)
model = Sequential()
model.add(Conv2D(150, (3,3), padding='same', strides=2, input_shape=(28,28,1), activation='relu'))
...
# Flatten : 0.8859000205993652

# GlobalAveragePooling2D : 0.8906000256538391