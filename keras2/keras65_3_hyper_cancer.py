...
# model.best_params_ :  {'opti': 'rmsprop', 'node3': 16, 'node2': 64, 'node1': 64, 'drop': 0.2, 'batch_size': 200, 'activation': 'linear'}
# model.best_estimator_ :  <keras.wrappers.scikit_learn.KerasClassifier object at 0x0000024507B7AF10>
# model.best_score_ :  0.8481178085009257
# 1/1 [==============================] - 0s 51ms/step - loss: 4.0514 - acc: 0.9123
# model.score :  0.9122806787490845