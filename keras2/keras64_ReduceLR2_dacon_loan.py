...
# f1 :  0.06581373707617563
# f1 :  0.06581373707617563
# f1 :  0.8962191526578984
# f1 :  0.8203142132329589
# f1 :  0.8013729373392613
...
######################## COMPILE, FIT Start ######################
model.compile(loss='categorical_crossentropy', optimizer=Adam(learning_rate=1.0), metrics=['accuracy'])
es = EarlyStopping(monitor='val_loss', mode='min', patience=15, verbose=1, restore_best_weights=True)
model.fit(X_train, y_train, epochs=10000, batch_size=1500, validation_split=0.2, callbacks=[es, rlr])
######################## COMPILE, FIT End ########################
