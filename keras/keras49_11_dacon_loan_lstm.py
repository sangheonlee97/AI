...
X_train = X_train.reshape(-1, 4,3)
X_test = X_test.reshape(-1,4 , 3)
test_csv = test_csv.reshape(-1,4,3)
######################### DATA End ###############################
...
# print(sub_csv['대출등급'])
filename = "".join(["..//_data//_save//dacon_loan_LSTM_", str(f1.round(4))])
model.save(filename + ".h5")
submission_csv.to_csv(path + "submisson_LSTM.csv", index=False)
