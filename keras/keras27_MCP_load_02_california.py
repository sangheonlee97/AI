...
hist = model.fit(X_train, y_train, epochs=500, batch_size=142, validation_split=0.3, callbacks=[es,mcp])
model = load_model('..//_data//_save//MCP//keras26_california_1.h5')
