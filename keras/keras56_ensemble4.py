...
merge2 = Dense(7, name='mg2')(op1)
merge3 = Dense(11, name='mg3')(merge2)
last_output = Dense(1, name='last')(merge3)
last_output2 = Dense(1)(merge3)
model = Model(inputs=ip1, outputs=[last_output, last_output2])

model.summary()

# 3 
model.compile(loss='mse', optimizer='adam')
model.fit(X_train, [y1_train, y2_train], epochs=1000, batch_size=35)

res = model.evaluate(X_test, [y1_test, y2_test])
print("loss : ", res)
