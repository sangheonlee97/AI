...
es = EarlyStopping(monitor='val_accuracy', mode='max', patience=300, verbose=1, restore_best_weights=True)

model.fit(X_train, y_train, epochs=10000, validation_split=0.15, callbacks=[es])
